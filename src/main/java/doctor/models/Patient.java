...
public class Patient extends User {
	...
	// Constructor
	public Patient(int userId, int patientId, String patientName, String patientEmail, String patientEncryptedPassword,
			String userSalt, String patientIdNumber) {
	...
	public List<BitalinoPackage> getMeasuredPackages() {
		return this.measuredPackages;
	}

	public void setMeasuredPackages(List<BitalinoPackage> measuredPackages) {
		this.measuredPackages = measuredPackages;
	}
