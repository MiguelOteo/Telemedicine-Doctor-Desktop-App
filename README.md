...
Once the user logs-in a pop-up will be display for the doctor to identify himself as a real doctor, in this case the ID uses the format of 8 digits and a letter form a list, in reality this ID should be verify aginst a hospital data-base to validate the doctor authenticity. 
