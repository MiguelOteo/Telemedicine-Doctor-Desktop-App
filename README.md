...
When a available time of 20 minutes is selected the graph of both the EMG and the ECG can be seen for the doctor to analyse them an detect some possible epilepsia attack.
<div align="center">
